        ...
        if(repositories.checked){
            ...
            conectWithAPI((resp)=>{
                ...
                resp.items.forEach(({html_url,owner,login})=>{
                    ...
                    const resultItem = new ResultItem(resultList,html_url,owner.avatar_url,owner.login);
                    resultItem.create();
            ...
            conectWithAPI((resp)=>{
                ...
                resp.items.forEach(({html_url,avatar_url,login})=>{
                    ...
                    const resultItem = new ResultItem(resultList,html_url,avatar_url,login);
                    resultItem.create();
                    resultItem.setAvatar();
                    resultItem.setText();
                });
            ...
            conectWithAPI((resp)=>{
                ...
                resp.items.forEach(({url,name,created_at})=>{
                    ...
                    const resultItem = new ResultItem(resultList,url,null,name,created_at);
                    resultItem.create();
                    resultItem.setText();
            ...
            conectWithAPI((resp)=>{
                ...
                resp.items.forEach(({html_url,user,title})=>{
                    ...
                    const resultItem = new ResultItem(resultList,html_url,user.avatar_url,title);
                    resultItem.create();
                    resultItem.setAvatar();
                    resultItem.setText();
                });
...
////RESULT CONTAINER SLIDE DOWN
    ...
    searchZone.addEventListener('keyup',(e)=>e.keyCode == 13 ? resultcontainer.style.transform = 'scale(1,1)' : false);
}
